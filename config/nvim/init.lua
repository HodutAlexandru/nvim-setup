  ...
  },
  {
          ...
          if client and client.name == 'jdtls' then
            ...
            local safe_map = function(keys, func_name, desc, mode)
              if jdtls[func_name] and type(jdtls[func_name]) == 'function' then
                -- For visual mode, wrap the function to pass true parameter
                if mode == 'v' then
                  map(keys, function() jdtls[func_name](true) end, desc, mode)
                else
	...
	-- ... etc. See `:help lspconfig-all` for a list of all the pre-configured LSPs
      ...
      require('mason-lspconfig').setup {
        ensure_installed = { 'bashls', 'lua_ls', 'jdtls', 'yamlls' }, -- LSP servers to auto-install
